...
const ExperienceBar = () => {
    return (
        <Box>
            <VerticalTimeline lineColor="#5F967C" layout={"1-column-left"} animate={true}>
                <VerticalTimelineElement
                    ...
                    icon={<Box>
                        <Image  padding="1px" paddingLeft="1px" background='white' borderRadius="50%" src={"images/nasa.png"}/>
                    </Box>
                    }
                >
                ...
                >
                    ...
                    <Text>
                        I helped in
                        developing and fine-tuning a chatbot utilizing AI to help customers with information
                        related to their bank account that was used by over 1,000 users
                        daily and deployed on Microsoft Azure. Additionally, I
                ...
                <VerticalTimelineElement
                    ...
                    icon={
                    <Image borderRadius="50%" src={"images/mobalyticslogo.jpg"}/>
                    }
                    >
                    <Heading as="h3" size="md" mb={2}>
                        Mobalytics
